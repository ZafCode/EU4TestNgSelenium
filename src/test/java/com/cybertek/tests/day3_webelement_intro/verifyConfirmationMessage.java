...
public class verifyConfirmationMessage {
    ...
    public static void main(String[] args) {
        ...
        //String actualMessage = actualConfirmationMessage.getText(); It is possible to do it as below

        if(expectedMessage.equals(actualConfirmationMessage.getText())){
            System.out.println("PASS");
        }else{
            System.out.println("FAIL");
            System.out.println("expectedMessage = " + expectedMessage);
            System.out.println("actualMessage = " + actualConfirmationMessage.getText());
        }
